...
function Internfair(){
    return(
        <div className='IF'>
            ...
            <div className='details1'>  <span className="font-bold">Unlock industry partnership</span><br /><br />
            ...
            <div><button className='event-registraion btn flex' onClick={() => window.open('https://unstop.com/p/intern-fair-your-gateway-to-internships-iit-guwahati-1331100', '_blank')}>Register Now ↗</button></div>
            </div>
